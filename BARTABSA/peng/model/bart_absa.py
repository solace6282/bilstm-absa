...
class FBartDecoder(Seq2SeqDecoder):
    ...
    def forward(self, tokens, state):
        ...
        a = tokens - self.src_start_index
        src_tokens_index = a.masked_fill(src_tokens_index.lt(0), 0)
...
class BartSeq2SeqModel(Seq2SeqModel):
    ...
    def build_model(cls, bart_model, tokenizer, label_ids, decoder_type=None, copy_gate=False,
        ...
        print(type(model.encoder.embed_tokens.weight.data))
        print(type(model.decoder.embed_tokens.weight.data))
